            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.nav_locations:
                        Toast.makeText(MainActivity.this, "you clicked locations", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.nav_mail:
                        Toast.makeText(MainActivity.this, "you clicked mail", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.nav_task:
                        Toast.makeText(MainActivity.this, "you clicked tasks", Toast.LENGTH_SHORT).show();
                        break;
                    default:
